import type { BookAnalysisEvidenceItem } from "@0xnovelagent/shared/types/bookAnalysis";
import type { DocumentChapter, DocumentChapterSplitResult } from "@0xnovelagent/shared/types/knowledge";
