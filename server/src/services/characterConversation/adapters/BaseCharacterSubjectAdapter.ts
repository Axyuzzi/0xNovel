import type { BaseCharacter } from "@0xnovelagent/shared/types/novelCharacter";
import type { CharacterSubjectProjection } from "@0xnovelagent/shared/types/characterConversation";
