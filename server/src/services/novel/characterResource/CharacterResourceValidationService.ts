...
import type { StateChangeProposal } from "@0xnovelagent/shared/types/canonicalState";
import { characterResourceUpdatePayloadSchema } from "@0xnovelagent/shared/types/characterResource";
