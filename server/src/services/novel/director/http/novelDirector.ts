...
import { DIRECTOR_POLICY_MODES } from "@0xnovelagent/shared/types/directorRuntime";
import {
  BOOK_FRAMING_COMMERCIAL_TAG_MAX_LENGTH,
  BOOK_FRAMING_MAX_COMMERCIAL_TAGS,
} from "@0xnovelagent/shared/types/novelFraming";
import { DIRECTOR_AUTO_APPROVAL_POINTS } from "@0xnovelagent/shared/types/autoDirectorApproval";
