import type { Character, CharacterVisibleProfileField } from "@0xnovelagent/shared/types/novel";
import type { CharacterResourceLedgerItem } from "@0xnovelagent/shared/types/characterResource";
