...
| 桌面端设备 Key、同步注册与充值闭环 | 📋 计划中 | `desktop/`、`server/src/relay/`、`client/src/pages/auth/`、`client/src/pages/account/`、`shared/types/` | [实施方案](wiki/architecture/desktop-device-key-auth-plan.md)；等待中转站注册、设备 Token、币种与幂等契约确认 |
