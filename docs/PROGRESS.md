...
| C 端单作品文档型创作台 | 📋 计划中 | `client/src/pages/novels/`、作品工作区组件、编辑器、版本历史与 AI 助手 | [产品原则](wiki/product/beginner-first-novel-completion.md#单作品文档型创作台)；左侧内容树、中间统一编辑器、右侧按需 AI；默认逐章确认，可连续创作到剧情阶段边界，深度审校由用户在阶段或卷末决定 |
