...
- `pnpm --filter @0xnovelagent/shared build`
- `pnpm --filter @0xnovelagent/server build`
- `pnpm --filter @0xnovelagent/client typecheck`
...
- 验证命令：`pnpm --filter @0xnovelagent/shared build`、`pnpm --filter @0xnovelagent/server build`、`pnpm --filter @0xnovelagent/client typecheck`、`node --test server/tests/directorControlPlaneBoundary.test.js server/tests/directorRunCommandService.test.js server/tests/directorExecutionService.test.js server/tests/directorWorker.test.js`。
