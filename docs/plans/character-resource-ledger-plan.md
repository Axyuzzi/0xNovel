...
- `pnpm --filter @0xnovelagent/client build`
...
- 本轮验证通过 `pnpm --filter @0xnovelagent/shared build`、`pnpm --filter @0xnovelagent/server build`、`pnpm --filter @0xnovelagent/client build` 和资源提交 / 章节上下文 targeted tests。
